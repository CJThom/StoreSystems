...
//include(":core:preferences:preferences-api")
//include(":core:preferences:preferences-data")
//include(":core:session:session-api")
//include(":core:session:session-domain")
//include(":core:session:session-data")
//include(":core:auth-bridge:auth-bridge-domain")
